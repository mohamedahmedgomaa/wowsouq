...
class SellerSoftDeleteDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('soft_delete', 'admin.sellers.btn.soft_delete')
            ->addColumn('restore', 'admin.sellers.btn.restore')
            ->rawColumns([
                'soft_delete',
                'restore',
            ]);
    ...
    {
        return Seller::query()->onlyTrashed()->select('sellers.*');
    }
