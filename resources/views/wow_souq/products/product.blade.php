            ...
            <div class="row s_product_inner">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                ...
                                <li data-target="#carouselExampleIndicators" data-slide-to="1">
                                    <img src="{{asset('wow_souq')}}/img/product/single-product/s-product-s-3.jpg"
                                         alt=""/>
                                </li>
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img
                                        class="d-block w-100"
                                        src="{{asset('wow_souq')}}/img/product/single-product/s-product-1.jpg"
                                        alt="Second slide"
                                    />
                                </div>
                                <div class="carousel-item">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        <div class="card_area">
                            <a class="main_btn" href="{{ route('client.getAddToCart', ['id' => $product->id]) }}">Add to Cart</a>
                            ...
                            <div class="comment_list">
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img
                                                src="{{asset('wow_souq')}}/img/product/single-product/review-1.png"
                                                alt=""
                                            />
                                        </div>
                                ...
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img
                                                src="{{asset('wow_souq')}}/img/product/single-product/review-3.png"
                                                alt=""
                                            />
                                        </div>
                                        <div class="media-body">
