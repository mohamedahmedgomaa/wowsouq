        ...
        <div class="banner_inner d-flex align-items-center">
            <div class="container">
                <div class="border border-dark"
                    ...
                    <form method="post" action="{{ route('wowsouq.seller.forget.password') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="col-lg-12" style="margin-top: 20px;font-size: 17px">
                            ...
                            <a href="{{url('seller/login')}}" class="genric-btn primary-border circle"
                               style="margin-left: 50px;">{{trans('web.login')}}</a>
                        </div>
                        <div class="col-lg-3" style="margin-top: 20px;font-size: large">
                            <a href="{{url('seller/register')}}" class="genric-btn primary circle"
